...
- Interfaz construida con Tailwind CSS y apoyo de CSS personalizado para ajustes específicos.
- Sistema de modo oscuro persistente mediante LocalStorage.
- Historial de cálculos que se mantiene tras recargar la página.
- Diseño adaptativo para dispositivos móviles.
- Código JavaScript optimizado para el manejo de la lógica y el historial.
